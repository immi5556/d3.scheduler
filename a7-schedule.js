var a7 = (function (win, d3abru) {
    ...
    return function (selector) {
        ...
        var buildTasks = function () {
            ...
            var gtask = svg.append("g")
                .attr("class", "g-taks");

            gtask.selectAll(".tasks-i")
            .data(taksarr)
            .enter()
            .append("rect")
            ...
            function collide(node1) {
                var node = d3.select(node1),
                  x1 = parseFloat(node.attr("x")),
                  x2 = x1 + parseFloat(node.attr("width")),
                  y1 = parseFloat(node.attr("y")),
                  y2 = y1 + parseFloat(node.attr("height"));
                var colliding = false;
                timebar.each(function (d, i) {
                    ...
                    if (!(x1 > nx2 || x2 < nx1 || y1 > ny2 || y2 < ny1) && !colliding) {
                        ...
                        //    //curolap
                        //    //    .style("fill", function (d, i) {
                        //    //        return colorbrewer.Pastel1[9][(cridx % 9)];
                        //    //    });
                        //}
                        //else {
                        //    colliding = true;
                        //    sx1 = nx1; sx1 = nx2; sy1 = ny1; sy2 = ny2; cridx = i;
                        //    curolap = d3.select(this);
                        //}
                        curolap = this;
                        sx1 = nx1; sx1 = nx2; sy1 = ny1; sy2 = ny2; cridx = i;
                        colliding = true;
